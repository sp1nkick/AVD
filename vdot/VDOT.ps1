<#
    ...
    .NOTES
        ...
        Changelog:      
			...
			7-2-2024  tll      1.1 - Download to qualitech, change AppPackage.json target, change vdot run command .\Windows_VDOT.ps1 -Optimizations All -Verbose -AcceptEula
    .COMPONENT
...
$apppackages = 'https://sharesync.serverdata.net/us/s/fPW8XwYL58W6l1ExrGES1Q001e87a8/AppxPackages.json'
...
C-Item $apppackages_location -Destination 'C:\Optimize\Virtual-Desktop-Optimization-Tool-main\2009\ConfigurationFi\AppxPackages.json'
